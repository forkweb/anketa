...
.personnel_file::after {
    content: "";
    position: absolute;
    background-image: url("../assets/img/topsecret.png");
    width: 252px;
    height: 106px;
    margin: 0 auto;
    top: 47px;
...
.content_file {
    padding: 330px 110px 75px 110px;
    text-align: left;
}
